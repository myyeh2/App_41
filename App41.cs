// .NET 8. @ C:\2302\Misc_10\App_41
// Dennis G. Zill "Differential Equations with Boundary-Value
// Problems 9th Edition"  Page 322 Example 1  

using Matrix_0; 

// 已知數據(空間維度m=2,狀態維度r=2) 
double[,] M = { { 1, 0 }, { 0, 1 } };
double[,] C = { { 0, 0 }, { 0, 0 } };
double[,] K = { { 10, -4 }, { -4, 4 } };
// t=0時的初始值[y'0|y'1|y0|y1] = [1|-1|0|0]
double[,] y0Start = { { 1 }, { -1 }, { 0 }, { 0 } };

// 建構系統矩陣A 
SysMatrix2 SysMat = new SysMatrix2(M, C, K); 
ReMatrix A = SysMat.GetMatrix; 
...
// 列印節點之狀態響應(變位，速度，和加速)，適用於Excel繪圖 
...
// 列印時間、變位、速度、和加速度等序列，適用於Matplotlib.pyplot套件繪圖。
...
***     系統特徵矩陣D     ***
 -0.00000 +  3.46410i,   0.00000 +  0.00000i, 
  0.00000 +  0.00000i,   0.00000 +  0.00000i

  0.00000 +  0.00000i,  -0.00000 -  3.46410i, 
  0.00000 +  0.00000i,   0.00000 +  0.00000i

  0.00000 +  0.00000i,   0.00000 +  0.00000i, 
  0.00000 +  1.41421i,   0.00000 +  0.00000i

  0.00000 +  0.00000i,   0.00000 +  0.00000i, 
  0.00000 +  0.00000i,   0.00000 -  1.41421i
